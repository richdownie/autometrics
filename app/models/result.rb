class Result < ActiveRecord::Base
  ...
  named_scope :custom_field_dependencies_feature, :conditions => ['title LIKE ?', '%custom_field_dependencies.feature']
  ...
  named_scope :issues_null_email_templates_feature, :conditions => ['title LIKE ?', '%issues_null_email_templates.feature%']
